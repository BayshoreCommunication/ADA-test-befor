    ...
    <section className="max-w-[1640px] mx-auto px-8 md:my-16 my-8">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-10">
        ...
        <Reveal tag="div" delay={0.2}>
          <Link
            href="/team"
            className="mt-4 md:mt-0 border border-gray-300 rounded-full px-5 py-2 font-medium inline-flex items-center gap-2 transition hover:bg-black hover:text-white"
          >
            Explore Team Members <span aria-hidden="true">-&gt;</span>
          </Link>
        </Reveal>
      </div>
