      ...
      <div>
        <Reveal tag="div" y={16} opacityFrom={0}>
          <div className="text-center">
            <h2 className="text-3xl lg:text-[38px] font-bold text-gray-900">Our Team</h2>
          ...
          {teammatesData.map((member) => (
            ...
            >
              ...
              <div className="px-6 pt-4 pb-6 flex-1">
                <h3 className="text-xl uppercase font-semibold text-gray-800">{member.name}</h3>
                <p className="text-primary font-medium mt-1">{member.designation}</p>
                <p className="text-gray-600 mt-3 line-clamp-2">{member.details}</p>
          ...
          >
            ...
            <div className="flex flex-col max-w-6xl w-full gap-6 items-center">
              <div className="flex-1 flex flex-col md:flex-row items-center gap-6 md:gap-12 w-full">
                ...
                />
                <div>
                  <h3 id={titleId} className="text-xl lg:text-3xl font-semibold text-gray-800 uppercase">
                    {selectedMember.name}
                  </h3>
                  <p className="text-primary font-medium mt-1">{selectedMember.designation}</p>
                </div>
              </div>
